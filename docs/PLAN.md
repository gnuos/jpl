...
| 批次 | 示例 | 说明 | 状态 |
|------|------|------|------|
| 9.6.1 | HTTP 服务器 | 基于 TCP 实现完整 HTTP 服务器 | 🔲 待开始 |
| 9.6.2 | WebSocket 协议 | 基于 TCP 实现 WebSocket 握手 | 🔲 待开始 |
| 9.6.3 | Redis 客户端 | RESP 协议实现 | 🔲 待开始 |
| 9.6.4 | 聊天室 | 多客户端广播（Unix Socket）| 🔲 待开始 |
| 9.6.5 | 文件上传服务器 | 展示二进制协议处理 | 🔲 待开始 |
